        ...
        <div className="cd-viewport">
          ...
          <header className="cd-header animate-fade-up">
            ...
            <div className="cd-header-right">
              ...
              <button onClick={handleLogout} className="cd-logout-btn" aria-label="Log out" style={{ background: 'transparent', border: 'none', color: 'var(--text-secondary)', cursor: 'pointer' }}>
          ...
          <nav className="cd-bottom-nav">
            ...
            <button className="cd-nav-item" onClick={handleLogout}>
              <svg width="22" height="22" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1"/></svg>
              <span>Logout</span>
            </button>
          </nav>
          {/* Floating logout button for mobile (keeps above bottom nav) */}
          <button onClick={handleLogout} className="cd-floating-logout" aria-label="Log out">
            <svg width="18" height="18" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1"/></svg>
          </button>
        </div>
      </div>
